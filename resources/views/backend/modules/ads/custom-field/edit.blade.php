        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card mb-30">
                <div class="card-header bg-white border-bottom2 py-3">
                    <h4>{{ translate('Custom Field Information') }}</h4>
                </div>
                <div class="card-body">
                    <!--Language Switcher-->
                        ...
                        @foreach (getAllLanguages() as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                    href="{{ route('classified.ads.custom.field.edit', ['id' => $field->id, 'lang' => $language->code]) }}">
                    ...
                    <form action="{{ route('classified.ads.custom.field.update') }}" method="POST">
                        @csrf
