 <form id="member-update-form">
     ...
     <div class="form-row mb-20">
         ...
         <input type="text" name="name" value="{{ $member->name }}" class="theme-input-style">
     </div>
     <div class="form-row mb-20">
         <label class="black font-14">{{ translate('Email') }}</label>
         <input type="email" name="email" value="{{ $member->email }}" class="theme-input-style">
     </div>
     <div class="form-row mb-20">
         <label class="col-12 black font-14">{{ translate('Phone') }}</label>
         <input type="text" name="phone" value="{{ $member->phone }}" class="theme-input-style">
     </div>
     <div class="form-row mb-20">
