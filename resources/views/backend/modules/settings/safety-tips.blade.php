        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-1">{{ translate('Are you sure to delete this safety tips') }}?</p>
                    <form method="POST"
            ...
            $(document).on('click', '.store-new-tip', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            toastr.success('{{ translate('Safety tips created successfully') }}');
                            location.reload();
                        } else {
                            toastr.error('{{ translate('Safety tips create failed') }}');
                        }
                    },
