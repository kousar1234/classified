...
@section('title')
    {{ translate('Edit Quick Sell Tips') }}
@endsection
                ...
                <div class="tab-pane fade show active">
                    <div class="card">
                        <div class="card-header align-items-center bg-white d-flex justify-content-between">
                            <h4>{{ translate('Edit Quick Sell Tips') }}</h4>
                            <a class="btn long"
                                href="{{ route('plugin.classilookscore.classified.settings.quick.sell.tips.list') }}">{{ translate('Quick Sell Tips List') }}
                            </a>
                        </div>
                        <div class="card-body">
                            <!--Language Switcher-->
