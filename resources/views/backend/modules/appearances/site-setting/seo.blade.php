                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ translation('Seo Setting') }}</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div
                                            ...
                                            <form method="POST"
                                                ...
                                                <div class="form-group">
                                                    <label>{{ translation('Meta Keys') }}</label>
                                                    <textarea class="form-control" name="site_meta_keys">{{ get_setting('site_meta_keys') }}</textarea>
                                                    <span
                                                        class="text-indigo">{{ translation('Separate each keys with coma(,)') }}</span>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-row justify-content-end">
                                                    <button type="submit" class="btn btn-primary">{{ translation('Save Change') }}
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
