                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ translation('Edit Why Choose Us') }}</h3>
                        </div>
                        <div class="card-body">
                                ...
                                @foreach (activeLanguages() as $key => $language)
                                    <li class="nav-item">
                                        <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                            href="{{ route('admin.appearance.why.us.edit', ['id' => $item->id, 'lang' => $language->code]) }}">
                            ...
                            <form id="new-item-item-form" method="POST"
                                action="{{ route('admin.appearance.why.us.update') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description"
                                                value="{{ $item->translation('description', $lang) }}"
